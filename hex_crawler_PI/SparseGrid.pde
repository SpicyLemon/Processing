class SparseGrid<T> {
  ...
  T Get(Spot s) {
    return this.Get(s.IndexX, s.IndexY);
  }
  ...
  SparseGrid Set(Spot s, T value) {
    return this.Set(s.IndexX, s.IndexY, value);
  }
  ...
  boolean Has(Spot s) {
    return this.Has(s.IndexX, s.IndexY);
  }
  ...
  SparseGrid Delete(Spot s) {
    return this.Delete(s.IndexX, s.IndexY);
  }
